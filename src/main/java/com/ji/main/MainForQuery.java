...
public class MainForQuery {
	...
	public static void main(String[] args) {
		...
		printTeam("findByNameLike(SW팀)", teamRepo.findByName("SW팀"));
	...
	private static void useBasicFindByQueryMethod(EmployeeRepository empRepo) {
		...
		printEmployees("findByNameStaringWithOrderByNameAsc", empRepo.findByNameStartingWithOrderByNameAsc("제임스"));
