...
public class EventController {
	...
	protected void initBinder(WebDataBinder binder) {
		CustomDateEditor dateEditor= new CustomDateEditor(new SimpleDateFormat("yyyMMdd"), true);
		binder.registerCustomEditor(Date.class, dateEditor);
	}
	
	@RequestMapping("/detail")
	public String datail(HttpServletRequest request, Model model) throws IOException{
